...
Generation verdict: `PARTIAL`. Quota progress: `{'all_minimums_met': False, 'heldout': {'behaviorally_diverse_groups': 8, 'candidate_pairs': 4116, 'groups': 147, 'minimum_met': False, 'non_tie_pairs': 64, 'parse_rate': 0.9047619047619048, 'quota_minimums': {'behaviorally_diverse_groups': 20, 'non_tie_pairs': 120, 'task_ids': 8}, 'reward_diverse_groups': 7, 'stability_rate': 0.98, 'stable_primary_rows': 1176, 'task_ids': 10, 'task_ids_with_non_tie_pair_list': ['OpenBookQA/14', 'OpenBookQA/18', 'mmlu/high_school_chemistry/1'], 'task_ids_with_non_tie_pairs': 3, 'tie_pairs': 4052, 'tie_rate': 0.9844509232264335}, 'train': {'behaviorally_diverse_groups': 52, 'candidate_pairs': 7000, 'groups': 250, 'minimum_met': False, 'non_tie_pairs': 617, 'parse_rate': 0.6975, 'quota_minimums': {'behaviorally_diverse_groups': 60, 'non_tie_pairs': 250, 'task_ids': 24}, 'reward_diverse_groups': 47, 'stability_rate': 1.0, 'stable_primary_rows': 2000, 'task_ids': 40, 'task_ids_with_non_tie_pair_list': ['ARC-Challenge/1', 'ARC-Challenge/19', 'ARC-Challenge/2', 'OpenBookQA/3', 'mmlu/anatomy/12', 'mmlu/anatomy/8', 'mmlu/high_school_chemistry/10', 'mmlu/high_school_physics/11', 'sciq/sciq/22'], 'task_ids_with_non_tie_pairs': 9, 'tie_pairs': 6383, 'tie_rate': 0.9118571428571428}, 'val': {'behaviorally_diverse_groups': 12, 'candidate_pairs': 2800, 'groups': 100, 'minimum_met': False, 'non_tie_pairs': 173, 'parse_rate': 0.95125, 'quota_minimums': {'behaviorally_diverse_groups': 15, 'non_tie_pairs': 60, 'task_ids': 6}, 'reward_diverse_groups': 12, 'stability_rate': 1.0, 'stable_primary_rows': 800, 'task_ids': 8, 'task_ids_with_non_tie_pair_list': ['ARC-Challenge/17'], 'task_ids_with_non_tie_pairs': 1, 'tie_pairs': 2627, 'tie_rate': 0.9382142857142857}}`.

## Recipe Controller

The local Hunter-Seeker-inspired controller verdict is `INSUFFICIENT`. It is a recipe allocator only and does not use the actual architecture or action/runtime code paths.

## Heldout Selector Result

Selector eval verdict: `STILL_DATA_LIMITED`. Best available selector: `ensemble`. Readiness support: `{'heldout_task_ids': 3, 'heldout_pair_count': 64, 'behaviorally_diverse_heldout_groups': 7, 'readiness_support_met': False}`.

## Old-Context Replay

Old-context replay verdict: `PARTIAL_MATCH`. This is diagnostic only and does not replace old BG routing.

## Geometry

Geometry verdict: `OLD_GEOMETRY_CONFIRMED` with summary `{'max_abs_old_tap_alignment': 0.9862316250801086, 'v1_v2_v3_v4_alignment': 0.9981817603111267, 'v4_vs_salvage_alignment': 0.9981817603111267, 'old_context_replay_geometry_compatibility': 'PARTIAL_MATCH'}`.

## Phase 2 Implication

`PHASE2_HIDDEN_BRANCH_EVALUATOR_STATUS_V4 = STILL_DATA_LIMITED`. Inspect quota failures and continue only if a clear recipe remains under the primary-safe constraints.
