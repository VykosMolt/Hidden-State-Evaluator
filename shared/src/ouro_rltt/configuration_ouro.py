...
class OuroConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        rltt_logprob_chunk_size=None,
        rltt_loop_level_checkpointing=True,  # Memory-efficient: recompute loops during backward
        **kwargs,
    ):
        ...
        self.rltt_logprob_chunk_size = rltt_logprob_chunk_size
        self.rltt_loop_level_checkpointing = rltt_loop_level_checkpointing
