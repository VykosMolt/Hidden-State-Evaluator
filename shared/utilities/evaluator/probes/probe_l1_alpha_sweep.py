...
Output: rpe/evaluator/probe_l1_alpha_sweep.json
"""
...
STATES_PT = "rpe/evaluator/hh_loop_states_200_thinking.pt"
HEAD_CKPT = "rpe/checkpoints/evaluator/pairwise_epoch2.pt"
OUT_JSON = "rpe/evaluator/probe_l1_alpha_sweep.json"
