...
OUT_ROOT = PROJECT_ROOT / "opi/control/depth_alloc_v3_20260726"
SEED = 20260726
...
MODELS = {
    "thinking26": PROJECT_ROOT / "shared/models/ouro_thinking_local",
    "rltt": PROJECT_ROOT / "shared/models/ouro_rltt_local",
}
