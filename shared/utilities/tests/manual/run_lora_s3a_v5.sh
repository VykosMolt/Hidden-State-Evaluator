...
# Sealed plan: opi/control/lora_s3a_pilot_20260727/EXPERIMENT_PLAN.md.
...
cd "$(dirname "$0")/../../.."
PY=./venv/bin/python
SCRIPT=shared/utilities/tests/manual/bg_v5_lora_binding.py
OUT=opi/control/lora_s3a_pilot_20260727
TOUR_LOG=opi/branching/tournament_v4_20260727/run.log
LOG=$OUT/run.log
mkdir -p "$OUT"
