...
Sealed plan: opi/branching/tournament_v4_20260727/EXPERIMENT_PLAN.md.
...
OUT_ROOT = PROJECT_ROOT / "opi/branching/tournament_v4_20260727"
SEED = 20260727
...
def stage_generate() -> None:
    ...
    torch.save({"seed": SEED, "task_offset": TASK_OFFSET, "n_tasks": N_TASKS,
                "B": B, "P": P, "max_new": MAX_NEW, "model": "shared/models/ouro_rltt_local",
