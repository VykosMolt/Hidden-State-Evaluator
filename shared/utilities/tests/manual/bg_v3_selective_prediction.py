...
OUT_ROOT = PROJECT_ROOT / "opi/control/selective_prediction_v3_20260726"
SEED = 20260724
...
def main() -> None:
    ...
    hp = json.load(open(PROJECT_ROOT / "opi/preanswer/horizon_power_v3_20260726/raw_predictions_heldout_v3.json"))
    ...
    rows = list(csv.DictReader(open(PROJECT_ROOT / "opi/verification/paper_verification/fable_hardening_checks_20260710_175017/preanswer_oof_predictions.csv")))
