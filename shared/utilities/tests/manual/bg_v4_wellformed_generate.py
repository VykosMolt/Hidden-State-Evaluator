...
Sealed plan: opi/branching/wellformed_terminal_v4_20260727/EXPERIMENT_PLAN.md.
...
OUT_ROOT = PROJECT_ROOT / "opi/branching/wellformed_terminal_v4_20260727"
SEED = 20260727
...
def main() -> None:
    ...
    payload = {
        ...
        "model": "shared/models/ouro_rltt_local", "feature_shape": [3, 4, 2048],
