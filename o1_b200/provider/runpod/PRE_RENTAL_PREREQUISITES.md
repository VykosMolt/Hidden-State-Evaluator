...
The B300 image is already built locally as `o1-b300-runner:v0.3.7`, local
image id `sha256:30474495b286ee7fd6269a744195eabb273e6ec2bb80ee204e7fbdb9dc1d449f`
...
`v0.3.7` tag after pushing; mutable tags are refused by the adapter.
Cross-check that GHCR reports the same digest the push returned:

```sh
docker buildx imagetools inspect ghcr.io/vykosmolt/o1-b300-runner:v0.3.7 \
