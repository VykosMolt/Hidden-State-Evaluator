...
The B300 production image is built locally as `o1-b300-runner:v0.3.4`
...
docker tag o1-b300-runner:v0.3.4 ghcr.io/vykosmolt/o1-b300-runner:v0.3.4
docker push ghcr.io/vykosmolt/o1-b300-runner:v0.3.4
```
