...
The B300 production image is built locally as `o1-b300-runner:v0.3.20`
...
docker tag o1-b300-runner:v0.3.20 ghcr.io/vykosmolt/o1-b300-runner:v0.3.20
docker push ghcr.io/vykosmolt/o1-b300-runner:v0.3.20
```
