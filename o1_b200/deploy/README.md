...
Release: **O1_B300_RUNNER v0.3.7**. Status: **B300 PREEMPTIBLE SOFTWARE
...
| file | purpose |
|---|---|
| `Dockerfile.b300` | reproducible image: CUDA 13.0 runtime (cuDNN 9.20.0.48, NCCL 2.29.7, triton 3.7.1), Python 3.14, pinned deps, sealed package + runner + axis package + cohort manifests baked in (checkpoint mounted, never baked); built by `scripts/build_b300_image.sh` as `o1-b300-runner:v0.3.7`, rebuilt local image id `sha256:55f2c45ddc6cbfe20771c7cfc20cdea503724a40fe82bf3e0265776b6c836f2d` (registry digest unresolved until pushed) |
