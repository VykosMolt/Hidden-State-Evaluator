...
| file | purpose |
|---|---|
| `Dockerfile.b300` | reproducible image: CUDA 13.0 runtime (cuDNN 9.20.0.48, NCCL 2.29.7, triton 3.7.1), Python 3.14, pinned deps, sealed package + runner + axis package + cohort manifests baked in (checkpoint mounted, never baked); built by `scripts/build_b300_image.sh` as `o1-b300-runner:v0.3.11`, rebuilt local image id `sha256:24fc8aab5a0f5552c249b2ea54e9352845cb8253d30f0c5350f00df02a03f336` (registry digest unresolved until pushed) |
