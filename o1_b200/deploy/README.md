...
Release: **O1_B300_RUNNER v0.3.5**. Status: **B300 PREEMPTIBLE SOFTWARE
...
| file | purpose |
|---|---|
| `Dockerfile.b300` | reproducible image: CUDA 13.0 runtime (cuDNN 9.20.0.48, NCCL 2.29.7, triton 3.7.1), Python 3.14, pinned deps, sealed package + runner + axis package + cohort manifests baked in (checkpoint mounted, never baked); built by `scripts/build_b300_image.sh` as `o1-b300-runner:v0.3.5`, rebuilt local image id `sha256:6ddf92b948973f2f3a5368c052b6be188bd7504479deda5d73e7f4664cf4bdc2` (registry digest unresolved until pushed) |
