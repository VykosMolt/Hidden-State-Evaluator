...
def train():
    ...
    print(f"Architecture: attention pool (attn_dim=256) -> MLP scorer, final loop state only")
    ...
    for epoch in range(EPOCHS):
        ...
        checkpoint_path = os.path.join(CHECKPOINT_DIR, f"evaluator_test_epoch{epoch + 1}.pt")
        torch.save({
