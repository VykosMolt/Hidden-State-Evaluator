...
Pilot complete, recorded in `math_bg_gate_pilot_2026-05-15.md`. 33 kept tournaments (26 GSM8K, 7 MATH), 25 train / 8 eval. All AntisymLinear configs at 24/36/47 hit 1.000 top-1 with zero cycles on the n=8 eval split. Treated as protocol/proof-of-possibility, not a gate decision. The uniform 1.000 result probably reflects easy-after-filtering tournaments rather than genuine signal saturation — the gate-scale follow-up must include difficulty-balanced sampling to test discrimination on hard tournaments.
