...
| --- | --- | --- |
| fresh same-content comparison | new two-tap `0.8818` vs old BG `0.8800` | `bg_two_tap_fresh_dataset_comparison_v1.md` |
| HH-RLHF comparison | new two-tap `0.6152` vs old BG `0.5977` | `bg_two_tap_hh_rlhf_comparison_v1.md` |
| layer-native two-tap readiness | `DOMAIN_READY_BRANCH_GAP` | `bg_layer_native_two_tap_readiness_v1.md` |
| constrained layer-native training | `DOMAIN_READY_BRANCH_GAP` | `bg_layer_native_two_tap_constrained_train_v1.md` |
| branch-gap repair | `DUALANCHOR_BRANCH_GAP_REDUCED` | `bg_dualanchor_branch_gap_repair_v1.md` |
